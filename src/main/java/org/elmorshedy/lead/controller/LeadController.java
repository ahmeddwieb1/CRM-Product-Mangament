...
public class LeadController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<LeadDTO> getLeadById(@ObjectIdParam @PathVariable ObjectId id) {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @DeleteMapping("/{id}")
    public ResponseEntity<String> deleteLead(@ObjectIdParam @PathVariable ObjectId id) {
    ...
    public ResponseEntity<LeadDTO> addNoteToLead(
            @ObjectIdParam @PathVariable ObjectId leadId,
